    ...
    <section className="pb-10">
      <div className="container">
        <h2 className="text-center text-4xl font-bold tracking-tight text-gray-500 sm:text-5xl">
          Read trusted <span className="text-primary">reviews from</span> our
          customers
        </h2>

        <div className="mt-8 [column-fill:_balance] sm:columns-2 sm:gap-6 lg:columns-3 lg:gap-8">
          <div className="mb-8 sm:break-inside-avoid">
            <blockquote className="rounded-lg  bg-gray-50 dark:bg-slate-900 p-6 shadow-sm sm:p-8">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="mt-0.5 text-lg font-medium dark:text-white text-gray-900 dark:text-white">
                    Paul Starr
                  </p>
                </div>
              </div>
