const Footer = () => {
  return (
    <footer className="dark:bg-black bg-white pb-4">
      <div className="container">
        ...
        <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div className="text-center sm:text-left">
            <p className="text-lg font-medium text-slate-500 ">About Us</p>
          ...
          <div className="text-center sm:text-left">
            <p className="text-lg font-medium text-slate-500">Our Services</p>
          ...
          <div className="text-center sm:text-left">
            <p className="text-lg font-medium text-slate-500">Resources</p>
          ...
          <div className="text-center sm:text-left">
            <p className="text-lg font-medium text-slate-500">Helpful Links</p>
