...
const Navbar = () => {
  let [toggelNav, setToggleNav] = useState(false);
  let handleOpenNav = () => {
    setToggleNav(!toggelNav);
  };
  let { toggleMode, setToggleMode } = useContext(themeContextMode);
  let handleMode = () => {
  ...
  return (
    <header className="py-5 relative dark:bg-black">
      <div className="container">
        <div className="flex h-16 items-center justify-between">
          <Link href={"/"} className="flex-1 md:flex md:items-center md:gap-12">
            <svg
              id="logo-75"
              className="w-[120px] h-[30px] sm:w-[186px] sm:h-[41px]"
              viewBox="0 0 186 41"
              fill="none"
            ...
            <div className="flex items-center gap-4">
              <div className="sm:flex sm:gap-4">
                <a
                  ...
                  <span className="relative inline-block border-2 border-black dark:border-white px-8 py-3 text-sm font-bold uppercase tracking-widest text-white group-active:text-opacity-75">
                    Logout
                  </span>
                </a>
                ...
                <div className="hidden md:flex">
                  <button onClick={handleMode} className="text-4xl">
                    {toggleMode == "light" ? "☀️" : "🌑"}
                  </button>
                </div>
              </div>
          ...
          <div
            className={`flex md:hidden transition-all duration-500 fixed  left-0 top-0 z-40 ${
              toggelNav ? "w-[60%] " : "w-0 opacity-0"
            }   h-screen flex-col justify-between border-e bg-white`}>
            <div className="px-4 py-6">
              ...
              <div className="flex items-center justify-between flex-wrap gap-2">
                ...
                <div
                  ...
                  className="bg-primary text-white cursor-pointer size-8 grid place-items-center rounded-full">
                  X
                </div>
              </div>
              <ul className="mt-6 space-y-1">
                <Link
                  className="block rounded-lg bg-gray-100 px-4 py-2 text-sm
            ...
            <div className="sticky inset-x-0 bottom-0 border-t border-gray-100">
              <div className="flex items-center gap-2 m-3 ">
                ...
                <div>
                  <p className="text-xs">
                    <strong className="block font-medium">Mostafa Rayan</strong>

                    <span> mr3309296@gmail.com </span>
                  </p>
                </div>
              </div>
            </div>
          ...
          <div
            className={`fixed transition-all duration-500 md:hidden inset-0 h-screen bg-black/40 ${
              toggelNav ? "w-full " : "w-0 opacity-0"
            }`}></div>
        </div>
      </div>
    </header>
